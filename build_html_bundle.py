...
# Update cache version to v=70
pre_style = re.sub(r'v=\d+', 'v=70', pre_style)
js_content = re.sub(r'sw\.js\?v=\d+', 'sw.js?v=70', js_content)
...
print(f"Successfully bundled index.html ({len(bundled)} bytes) with cache v=70")
